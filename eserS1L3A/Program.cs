namespace eserS1L3A
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            const string heading = " $$$$$$\\                            $$$$$$$\\                      $$\\       \r\n$$  __$$\\                           $$  __$$\\                     $$ |      \r\n$$ /  \\__| $$$$$$\\   $$$$$$\\        $$ |  $$ | $$$$$$\\  $$$$$$$\\  $$ |  $$\\ \r\n$$ |$$$$\\  \\____$$\\ $$  __$$\\       $$$$$$$\\ | \\____$$\\ $$  __$$\\ $$ | $$  |\r\n$$ |\\_$$ | $$$$$$$ |$$$$$$$$ |      $$  __$$\\  $$$$$$$ |$$ |  $$ |$$$$$$  / \r\n$$ |  $$ |$$  __$$ |$$   ____|      $$ |  $$ |$$  __$$ |$$ |  $$ |$$  _$$<  \r\n\\$$$$$$  |\\$$$$$$$ |\\$$$$$$$\\       $$$$$$$  |\\$$$$$$$ |$$ |  $$ |$$ | \\$$\\ \r\n \\______/  \\_______| \\_______|      \\_______/  \\_______|\\__|  \\__|\\__|  \\__|";

            Console.WriteLine(heading);
            Console.WriteLine();
            Console.Write("Salve, vuole aprire un conto alla \"GaeBank\"? Prema y per accettare o qualunque altra cosa per uscire: ");
            char answer = char.Parse(Console.ReadLine().ToLower());
            if (answer == 'y')
            {
                Console.WriteLine();
                Console.WriteLine("Benvenuto in questa incredibile banca!");
                Console.WriteLine();
                Console.WriteLine("Se vuole aprire il conto deve versare un minimo di 1000 euro.");
                ...
                Console.WriteLine(heading);
                Console.WriteLine("Congratulazioni, ora ha un conto presso la famosissima \"GaeBank\", le auguriamo buona permanenza.");
                Console.WriteLine();
                ...
                do
                {
                    Console.WriteLine("Benvenuto, utente 12312498329. Quale operazione vuole fare?");
